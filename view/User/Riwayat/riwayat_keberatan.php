<?php
require '../../../controller/RiwayatController/objectionHistory.php';
                        ...
                        <table class="table table-bordered">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td id='namaPemohon' data-nama-pemohon='{$row['nama_pemohon']}'>{$row['nama_pemohon']}</td>";
                                    echo "</tr>";
                                    ...
                                    echo "<td>{$row['kode_permohonan_informasi']}</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                ...
                                while ($row_alternatif = $result_alternatif->fetch_assoc()) {
                                    ...
                                    echo "<tr>";
                                    echo "<td><strong>Nomor Register Permohonan</strong></td>";
                                    echo "<td>{$row_alternatif['kode_permohonan_informasi']}</td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td><strong>Alasan Keberatan</strong></td>";
