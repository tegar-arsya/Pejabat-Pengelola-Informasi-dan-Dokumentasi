...
<head>
    ...
    <title>Daftar Keberatan Permohonan Informasi</title>
</head>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered zero-configuration">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM pengajuan_keberatan WHERE nik_pemohon = $nik";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <td>
                            <a href='riwayatKeberatan?registrasi=" . $row["nomer_registrasi_keberatan"] . "' class='btn btn-danger btn-sm'>Detail</a>
                            </td>
                            </tr>";
                            $counter++;
                        }
