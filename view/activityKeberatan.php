            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="card" style="text-align: center;">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Jawaban Keberatan Permohonan Informasi</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM keberatananswer_admin";
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr>
                                                        <td>{$no}</td>
                                                        <td>{$row['nama_pic']}</td>
                                                        <td>{$row['jawaban_keberatan']}</td>
                                                        <td><a href='../Assets/uploads/keberatan/jawabanKeberatan/{$row['lampiran']}' target='_blank'>Lihat / Unduh</a></td>
                                                        <td>" . strftime("%d %B %Y %H:%M:%S", strtotime($row['tanggal'])) . "</td>
