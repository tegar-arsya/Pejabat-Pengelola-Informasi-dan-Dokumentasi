...
document.getElementById('myForm').addEventListener('submit', function(event) {
    ...
    if (userInput === captchaValue) {
        ...
        fetch('../controller/simpan_data_pengajuan_keberatan.php', {
            method: 'POST',
        ...
        .then(data => {
            if (data.success) {
                ...
                Swal.fire({
                    ...
                    html: 'Permohonan informasi publik anda telah berhasil terkirim, untuk detail lebih lanjut mohon untuk dicek di bagian <a href="../view/daftarkeberatanPengguna" style="color: red; text-decoration: underline;">riwayat Keberatan</a>',
                    icon: 'success',
                });
