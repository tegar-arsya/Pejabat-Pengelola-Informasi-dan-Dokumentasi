...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO survey_kepuasan (nomer_registrasi, nama_pengguna, usia, pendidikan, pekerjaan, jenis_layanan, persyaratan, 
    ...
    VALUES ('$nomer_registrasi', '$nama', '$usia', '$pendidikan', '$pekerjaan', '$jenis_layanan', '$persyaratan', '$SaranPersyaratanPermohonanInformasi', '$prosedur', '$waktu',
