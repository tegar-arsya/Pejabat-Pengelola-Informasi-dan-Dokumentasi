...
class FormSubmissionHandler {
    ...
    public function handleFormSubmission() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $sql = "INSERT INTO permohonan_informasi (id_registrasi, nama_pengguna, opd_yang_dituju, informasi_yang_dibutuhkan, alasan_pengguna_informasi, cara_mendapatkan_informasi, cara_mendapatkan_salinan) 
                    VALUES ('$id_registrasi', '$nama_depan $nama_belakang', '$opd', '$informasi', '$alasan', '$caraMendapatkaninformasi', '$caraMendapatkanSalinan')";
