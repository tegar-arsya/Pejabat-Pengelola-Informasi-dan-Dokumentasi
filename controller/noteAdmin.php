...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "INSERT INTO note_admin (id_permohonan, nomer_registrasi_keberatan, nama_pemohon, keterangan, status ) VALUES (?, ?,  ?, ?, ?)";
    
    // Persiapkan statement
    $stmt = $conn->prepare($insertQuery);

    // Bind parameter ke statement
    $stmt->bind_param("sssss",$id_permohonan, $nomerRegistrasiKeberatan, $namaPemohon, $keterangan, $status );
