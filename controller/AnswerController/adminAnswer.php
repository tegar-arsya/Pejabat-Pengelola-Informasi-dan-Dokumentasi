...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($_FILES["lampiran"]["tmp_name"], $targetFilePath)) {
        $insertQuery = "INSERT INTO answer_admin (id_permohonan, nama_pic, jawaban_permohonan, lampiran, nomer_registrasi_pemohon, status_balasan) 
                        VALUES ( '$id_permohonan','$namaPIC', '$jawabanPermohonan', '$lampiranName','$norek','Jawaban permohonan informasi sudah kami kirimkan, silahkan masuk ke halaman riwayat permohonan sesuai dengan nomer registrasi permohonan anda untuk mengunduh jawaban permohonan.')";
        ...
        if ($insertResult) {
            ...
            $mail->addAddress($_POST['email'], $_POST['norek']);
